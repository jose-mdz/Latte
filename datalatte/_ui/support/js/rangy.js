/**
 * @license Rangy, a cross-DetailView JavaScript range and selection library
...
window['rangy'] = (function() {
    ...
    // http://peter.michaux.ca/articles/feature-detection-state-of-the-art-ApiDetailView-scripting
    ...
    function fail(reason) {
        window.alert("Rangy not supported in your ApiDetailView. Reason: " + reason);
...
rangy.createModule("DomUtil", function(api, module) {
    ...
    // Test the ApiDetailView's innerHTML support to decide how to implement createContextualFragment
    ...
    var createContextualFragment = htmlParsingConforms ?
        ...
        // Implementation as per HTML parsing spec, trusting in the ApiDetailView's implementation of innerHTML. See
    ...
    RangePrototype.prototype = {
        ...
        insertNode: function(node) {
            ...
            // children of the type of node: the ApiDetailView's DOM implementation should do this for us when we attempt
            // to add the node
    ...
    function createPrototypeRange(constructor, boundaryUpdater, detacher) {
        ...
        api.util.extend(constructor.prototype, {
            ...
            selectNodeContents: function(node) {
                ...
                // could be taken to mean only its children. However, DetailViews implement this the same as selectNode for
    ...
    function createBoundaryTextRange(boundaryPosition, isStart) {
        ...
        // for IERange suggests that it can crash the ApiDetailView: http://code.google.com/p/ierange/issues/detail?id=12
        if (boundaryNode) {
    ...
    if (api.features.implementsDomRange && (!api.features.implementsTextRange || !api.config.preferTextRange)) {
        // This is a wrapper around the ApiDetailView's native DOM Range. It has two aims:
        // - Provide workarounds for specific ApiDetailView bugs
        ...
        (function() {
            ...
            // insertNode in some circumstances, all DetailViews will have to use the Rangy's own implementation of
...
*/
    ...
    // No current DetailViews conform fully to the HTML 5 draft spec for this method, so Rangy's own method is always used
...
/*
 ...
 Part of Rangy, a cross-ApiDetailView JavaScript range and selection library
 http://code.google.com/p/rangy/
