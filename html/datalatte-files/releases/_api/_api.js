    ...
    var ApiDetailView = (function (_super) {
        ...
        */
        ...
        ApiDetailView.prototype.propertiesTable = function () {
            ...
            // Add headers
            table.append($('<tr></tr>').append($('<th>').text('')).append($('<th>').text('Name')).append($('<th>').text('Type')).append($('<th>').text('Description')));
        ...
        ApiDetailView.prototype.methodsTable = function () {
            ...
            // Add headers
            table.append($('<tr></tr>').append($('<th>').text('')).append($('<th>').text('Name')).append($('<th>').text('Arguments')).append($('<th>').text('Description')));
...
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/support/ts-include/_api.strings.d.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/support/ts-include/_ui.d.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/support/ts-include/_ui.strings.d.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/support/ts-include/datalatte.d.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/support/ts-include/jquery.d.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/PhpClassInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/PhpFieldInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/PhpMethodInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/ReflectionInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/TsPropertyInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/TsClassInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/TsEventInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/TsFieldInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/reflection/TsMethodInfo.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/views/ApiDetailView.ts" />
/// <reference path="/Users/josemanuel/Sites/latte.net/datalatte/_api/ts/views/MainApiView.ts" />
