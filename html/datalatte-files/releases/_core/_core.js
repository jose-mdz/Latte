    ...
    var GridView = (function (_super) {
        ...
        **/
        GridView.prototype.endCellEdit = function (cancelled) {
            if (typeof cancelled === "undefined") { cancelled = false; }
        ...
        **/
        GridView.prototype.onRowsChanged = function (dataset, oldDataset) {
            if (typeof oldDataset === "undefined") { oldDataset = null; }
    ...
    var RemoteCall = (function () {
        ...
        */
        function RemoteCall(moduleName, className, method, params, id, returns) {
            ...
            if (typeof id === "undefined") { id = 0; }
            if (typeof returns === "undefined") { returns = null; }
            //region Fields
                        ...
                        for (var i in metadata.fields) {
                            ...
                            if (field.type == 'record') {
                                ...
                                if (value && field['recordType'] && !(value instanceof latte.DataRecord)) {
                                    (function (d, input) {
                                        calls.push(new latte.RemoteCall('_core', 'DataLatteUa', 'recordSelect', { name: field['recordType'], id: value }).withHandlers(function (r) {
...
(function (latte) {
    ...
    */
    var DataRecordValueItem = (function (_super) {
        ...
        */
        function DataRecordValueItem(loader, textboxCreated) {
            if (typeof loader === "undefined") { loader = null; }
            if (typeof textboxCreated === "undefined") { textboxCreated = null; }
            _super.call(this);
            //endregion
            //region Properties
            /**
...
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/support/ts-include/_core.strings.d.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/support/ts-include/_ui.d.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/support/ts-include/_ui.strings.d.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/support/ts-include/datalatte.d.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/support/ts-include/jquery.d.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/DataSetColumn.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/DataSetRow.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/GridView.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/Cache.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/DataRecord.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/DataRecordCollection.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/DataSet.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/Message.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/RemoteCall.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data/RemoteResponse.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/DataRecordDialogView.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/DataRecordFormItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/DataRecordFormView.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/DataRecordGridView.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/DataRecordValueItem.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/GridViewColumn.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/datalatte/_core/ts/latte.data.ui/GridViewRow.ts" />
