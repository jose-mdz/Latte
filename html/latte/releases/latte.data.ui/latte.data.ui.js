...
(function (latte) {
    ...
    var DataRecordChildrenView = (function (_super) {
         ...
         */
        DataRecordChildrenView.prototype.reloadChildren = function () {
            this.onLoadChildren();
        };
...
(function (latte) {
    ...
    var DataRecordChildrenWidget = (function (_super) {
         ...
         * Reloads children
         */
        DataRecordChildrenWidget.prototype.reloadChildren = function () {
            this.onLoadChildren();
        };
                        ...
                        if (field.type == 'record') {
                            ...
                            if (value && field['recordType'] && !(value instanceof latte.DataRecord)) {
                                (function (d, input) {
                                    ...
                                    if (latte._isString(record['_moduleName'])) {
                                        // log("Added module")
...
(function (latte) {
    ...
    var DataRecordFormView = (function (_super) {
        ...
        DataRecordFormView.prototype.onSaveChanges = function () {
            var _this = this;
            _super.prototype.onSaveChanges.call(this);
            this.applyValues(this.record);
            this.record.save(function () { _this.unsavedChanges = false; });
        };
...
(function (latte) {
    ...
    var ExplorerView = (function (_super) {
                ...
                if (!this._btnSaveDetail) {
                    this._btnSaveDetail = new latte.ButtonItem(strings.save, latte.IconItem.standard(4, 2), function () {
                        if (_this.detailView.view) {
                            _this.detailView.view.saveChanges();
                        }
                    });
        ...
        Object.defineProperty(ExplorerView.prototype, "btnRefresh", {
            /**
             * Gets the refresh button
             *
             * @returns {ButtonItem}
            ...
            get: function () {
                var _this = this;
                if (!this._btnRefresh) {
                    this._btnRefresh = new latte.ButtonItem(null, latte.IconItem.refreshIcon(), function () {
                        _this.refreshList();
                    });
                }
                return this._btnRefresh;
...
/// <reference path="/Users/josemanuel/Sites/Latte/latte/latte.data.ui/ts/IDataRecordCustomForm.ts" />
/// <reference path="/Users/josemanuel/Sites/Latte/latte/latte.data.ui/ts/IDataRecordCustomView.ts" />
