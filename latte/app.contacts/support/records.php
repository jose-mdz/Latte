...
class categoryBase extends DataRecord{
	public $idcategory, $name, $i;
	public static function all($t = "Category"){ return array("$t.idcategory AS '$t.idcategory'", "$t.name AS '$t.name'", "$t.i AS '$t.i'"); }
	...
	public function getFields(){ return array( "name" => $this->name, "i" => $this->i ); }
